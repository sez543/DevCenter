...
function toggleTheme() {
  ...
  if (toggle.getAttribute("href").indexOf("dark") != -1) {
    toggle.setAttribute("href", "https://unpkg.com/vue-material/dist/theme/default.css");
    icon.innerHTML = "nights_stay";
  } else {
    toggle.setAttribute("href", "https://unpkg.com/vue-material/dist/theme/default-dark.css");
