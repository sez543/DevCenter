...
<head>
    ...
    <script src="scripts/main_404.js" defer></script>
    <script>
    const changeLanguage = () => {
        ...
        xmlhttp.open("GET", "./utilities/change_language.php?lang=" + str, true);
        xmlhttp.send();
    };
    </script>
    <style>
    ...
    .st9 {
        <?php if ($_COOKIE["theme"]=="dark") {
            ?>fill: var(--md-theme-default-background, #424242);
            <?php
        }

        else {
            ?>fill: var(--md-theme-default-background, #fff);
            <?php
        }
...
<body style="height: 100%">
    <div id="app">
                            ...
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 355">
                                    <g id="ocean">
                                        ...
                                        <linearGradient id="water_1_" gradientUnits="userSpaceOnUse" x1="500" y1="354"
                                            x2="500" y2="200.667">
                                    ...
                                    <g id="train">
                                        ...
                                        <g id="car-layers">
                                            ...
                                            <g id="Text">
                                                <text transform="translate(377.037 230.025)" class="st8 st10"
                                                    font-size="21">
                                                    404
                                                </text>
                                                <text transform="translate(<?php if (!isset($_COOKIE["language"])) {
            echo "539.5";
        } else {
        ...
        } ?> 213.994)" class="st8 st10" font-size="24.025">
                                                    <?php echo $err_404; ?>
                                                </text>
                                            </g>
                                            <g id="ladders">
                                                <g id="ladder-f">
                                                    <path id="front-ladder" class="st8"
